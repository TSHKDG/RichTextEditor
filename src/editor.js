function getContentCSS() {
  ...
  return `
    <style>
        ...
        pre{padding: 10px 5px 10px 10px;margin: 15px 0;display: block;line-height: 18px;border-radius: 6px;font-size: 13px; font-family: 'monaco', 'Consolas', "Liberation Mono", Courier, monospace; word-break: break-all; word-wrap: break-word;overflow-x: auto;}
...
<head>
    ...
    <style>
        ...
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;box-sizing: border-box;}
        html, body { margin: 0; padding: 0; font-size:1em; height: 100%}
        body { overflow-y: hidden; -webkit-overflow-scrolling: touch;caret-color: ${caretColor};}
        .content {color: ${color}; width: 100%;${
